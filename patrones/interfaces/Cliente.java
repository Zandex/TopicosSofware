...
public abstract class Cliente {
    ...
    public Cliente(int id, String nombre,String apellido, String genero,String fechaNacimiento,String estadoCivil ){
            this.id = id;
            this.nombre = nombre;
    ...
    public void saludar(){
        System.out.println("Hola soy un cliente No definido");
    }
}
